                          ...
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                fit: BoxFit.cover,
                                image: NetworkImage(
                                    myCourses[index].thumbnail.toString()),
                              ),
                            ),
                          ),
                          Positioned(
                        ...
                        children: [
                          RichText(
                            text: TextSpan(children: [
                              ...
                              TextSpan(
                                text: formatedData(
                                  myCourses[index].lastUpdated.toString(),
                                ),
                          ...
                          SizedBox(
                            width: double.infinity,
                            child: Text(
                              myCourses[index].title.toString(),
                              maxLines: 1,
